 ...
 *
 */
class Gmenoia_Paypalshiptonamefix_Model_Paypal_Express_Checkout extends Mage_Paypal_Model_Express_Checkout {
	...
	public function returnFromPaypal($token) {
		...
		$portBillingFromShipping = $quote->getPayment ()->getAdditionalInformation ( self::PAYMENT_INFO_BUTTON ) == 1 && $this->_config->requireBillingAddress != Mage_Paypal_Model_Config::REQUIRE_BILLING_ADDRESS_ALL && ! $quote->isVirtual ();
